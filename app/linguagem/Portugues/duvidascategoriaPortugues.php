...
<head>
  <meta charset="UTF-8">
  <meta name="description" content="duvidas categorias">
  <meta name="keywords" content="duvidas categorias">
  <meta name="author" content="onclickup">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title> onclickup | duvidas categorias</title>
  ...
  <main>
   ...
   <section class="main-experi">
    <nav class="nav d-flex justify-content-between">  
     {% for duvidaempresa in  getduvidacategoria %}           
      ...
      <section id="accordion">
        <article class="card border-left-dark" >
          <section class="card-header" id="headingOne">
           ...
           {% if admin_session  %}
           <a class="btn btn-outline-secondary btn-sm" href="/empresaduvidas/destroy/{{duvidas.duv_id}}"> excluir</a>
           {% endif %}
         </section>
