...
class indexingles extends Ingles {
	...
	public $keywords = "";
	public $author = "";
	public $betas_version = "Hi, it's a pleasure. we are in BETA phase";
	...
	public $main_about_h3 = "Learn more about us";
	public $main_about_P = "A company was born with a purpose to exploit people's abilities and thus make them believe in their entrepreneurial potential";
	public $main_features_1_h4 = "content by business area";
	public $main_features_1_p = " Track important metrics and indicators to achieve objectives and goals outlined in a visual way, facilitating understanding";
	public $main_features_2_h4 = "Auxiliary material";
	public $main_features_2_p = "Chat for easier interaction with partners";
	...
	public $main_services_card_1_h4 = "business proposals";
	public $main_services_card_1_p = "business proposals";
	public $main_services_card_2_h4 = "Dashboard";
	public $main_services_card_2_p = "Use our dashboard to control goals and metrics";
	public $main_services_card_3_h4 = "Notification";
	public $main_services_card_3_p = "Proposals Notification of activities on the platform";
	...
	public $main_contato_email = "starstuparcade@gmail.com";

	public $main_contato_form_nome = "Your name:";
	public $main_contato_form_email = "Email";
	public $main_contato_form_assunto = "Subject";
	public $main_contato_form_mensagem = "Message";
	public $main_contato_form_button = "send Message";
