...
<head>
  ...
  <title> SA | conversas privado</title>
...
<body id="page-top">
        ...
        <section class="col-xl-12 col-md-12 mb-4">
          ...
          <article class="card border-left-success shadow h-100 py-2">
            <section class="card-body">
              ...
              <h4 class ="text-dark" align="center">   conversas  </h4>
 ...
 <h5 class ="text-danger" align="center">              
              ...
              {% for grupo in getchatPrivadoMensagem %}
                  ...
                  <ul class="list-unstyled" class="mr-1">
                    <li class="media my-4">
                      ...
                      <section class="media-body"> 
                        ...
                        <h5 class="mt-0 mb-1 text-primary">{{grupo.mdl_nome}}</h5><br>
